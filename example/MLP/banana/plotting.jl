...
# read result
##########################
res_fwd = JLD2.load("result/MLP_fwd_err.jld2")
res_bwd = JLD2.load("result/MLP_bwd_err.jld2")
# res_elbo = JLD2.load("result/MLP_elbo_err.jld2")
# res_llh = JLD2.load("result/MLP_llh_err.jld2")
res_shadowing = JLD2.load("result/MLP_shadowing.jld2")
...
# # elbo
# #####################
# elbos = res_elbo["elbos"]
# elbos_big = Float32.(res_elbo["elbos_big"])
...
#     title="NF ELBO est.",
# )
# plot!(1:nlayers, elbos_big; label="exact")
# plot!(;
#     yaxis=:log10,
#     size=(800, 500),
#     xtickfontsize=30,
